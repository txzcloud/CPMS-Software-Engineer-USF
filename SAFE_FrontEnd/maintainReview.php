    ...
    echo "<table border=1>
     <thead>
        <tr>
            ...
            <th>Citation Of PreviousWork</th>
            <th>Originality</th>
            <th>Content Comments</th>
            <th>Origanization Of Paper</th>
            ...
            <th>Comfort Level Topic</th>
            <th>Comfort Level Acceptability</th>
            <th>Complete</th>
        </tr>
     </thead>";
       echo "<tbody>";
           ...
           while($row = sqlsrv_fetch_object($stmt))
            {
                ...
                . "</td><td>" . $row->PaperID
                . "</td><td>" . $row->ReviewerID
                . "</td><td>" . $row->AppropriatenessOfTopic
                . "</td><td>" . $row->TimelinessOfTopic
                . "</td><td>" . $row->SupportiveEvidence
                . "</td><td>" . $row->TechnicalQuality
                . "</td><td>" . $row->ScopeOfCoverage
                . "</td><td>" . $row->CitationOfPreviousWork
                . "</td><td>" . $row->Originality
                . "</td><td>" . $row->ContentComments
                . "</td><td>" . $row->OrganizationOfPaper
                . "</td><td>" . $row->ClarityOfMainMessage
                . "</td><td>" . $row->Mechanics
                . "</td><td>" . $row->WrittenDocumentComments
                . "</td><td>" . $row->SuitabilityForPresentation
                . "</td><td>" . $row->PotentialInterestInTopic
                . "</td><td>" . $row->PotentialForOralPresentationComments
                . "</td><td>" . $row->OverallRating
                . "</td><td>" . $row->OverallRatingComments
                . "</td><td>" . $row->ComfortLevelTopic
                . "</td><td>" . $row->ComfortLevelAcceptability
                . "</td><td>" . $row->Complete
                . "</td></tr>";
            }
